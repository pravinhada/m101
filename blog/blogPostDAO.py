...
class BlogPostDAO:
    ...
    def increment_likes(self, permalink, comment_ordinal):
        ...
        # 
        try:
            last_error = self.posts.update({'permalink':permalink},{'$inc':{"comments."+str(comment_ordinal)+".num_likes":1}},upsert=False, manipulate=False, safe=True)
            return last_error['n']
        except:
            print "Unexpected error while persisting likes", sys.exc_info()[0]
            return 0
